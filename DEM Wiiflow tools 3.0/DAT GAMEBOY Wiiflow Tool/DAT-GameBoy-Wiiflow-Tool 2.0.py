...
def list_txt_files():
    txt_folder = os.path.join(os.getcwd(), "gameboy plain text names")
    if not os.path.exists(txt_folder):
        print('The "gameboy plain text names" folder does not exist.')
        return False
    txt_files = [f for f in os.listdir(txt_folder) if f.endswith('.txt')]

    if not txt_files:
        print('No .txt files present in the "gameboy plain text names" folder.')
        return False

    return txt_files

def list_cover_art_files():
    art_folder = os.path.join(os.getcwd(), "gameboy cover art")
    if not os.path.exists(art_folder):
        print('The "gameboy cover art" folder does not exist.')
        return False
    ...
    if not art_files:
        print('No cover art files present in the "gameboy cover art" folder.')
        return False
...
def main():
    print("Thank you for using DAT Gameboy Wiiflow Tool!")
    ...
    if zip_files:
        ...
        if answer == 'yes':
            ...
            if txt_files:
                print("Here are the text files in the 'gameboy plain text names' folder:")
                for file in txt_files:
                    print(file)
                
                print("\n\n\n")
                answer = input("Would you like to match the names above to your GameBoy games and then rename them? (yes/no): ").strip().lower()
                ...
                if answer == 'yes':
                    ...
                    print("\n\n\nYour GameBoy games have been renamed!\n\n\n")
    ...
    if answer == 'yes':
        gameboy_games_folder = 'gameboy games'
...
Y8888D' YP   YP    YP                                                  
 ...
 d888b   .d8b.  .88b  d88. d88888b d8888b.  .d88b.  db    db           
88' Y8b d8' `8b 88'YbdP`88 88'     88  `8D .8P  Y8. `8b  d8'           
88      88ooo88 88  88  88 88ooooo 88oooY' 88    88  `8bd8'            
88  ooo 88~~~88 88  88  88 88~~~~~ 88~~~b. 88    88    88              
88. ~8~ 88   88 88  88  88 88.     88   8D `8b  d8'    88              
 Y888P  YP   YP YP  YP  YP Y88888P Y8888P'  `Y88P'     YP              
