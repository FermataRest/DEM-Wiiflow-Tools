...
def list_gameboy_games():
    gameboy_folder = os.path.join(os.getcwd(), "pocket color games")
    if not os.path.exists(gameboy_folder):
        print('The "pocket color games" folder does not exist.')
        return False
    zip_files = [f for f in os.listdir(gameboy_folder) if f.endswith('.zip')]

    if not zip_files:
        print('No .zip files present in the "pocket color games" folder.')
        time.sleep(5)
        return False
...
def list_txt_files():
    txt_folder = os.path.join(os.getcwd(), "pocket color plain text names")
    if not os.path.exists(txt_folder):
        print('The "pocket color plain text names" folder does not exist.')
        return False
    txt_files = [f for f in os.listdir(txt_folder) if f.endswith('.txt')]

    if not txt_files:
        print('No .txt files present in the "pocket color plain text names" folder.')
        return False

    return txt_files

def list_cover_art_files():
    art_folder = os.path.join(os.getcwd(), "pocket color cover art")
    if not os.path.exists(art_folder):
        print('The "pocket color cover art" folder does not exist.')
        return False
    ...
    if not art_files:
        print('No cover art files present in the "pocket color cover art" folder.')
        return False
...
def special_names():
    try:
        ...
        specific_renames = {
            # Add any specific renaming tasks here
        }
...
def main():
    print("Thank you for using DAT Neo-Geo Pocket Color Wiiflow Tool!")
    answer = input("Would you like to see your listed Pocket Color games? (yes/no): ").strip().lower()

    if answer == 'yes':
        zip_files = list_gameboy_games()
        if zip_files:
            print("Here are your Pocket Color games:")
    ...
    if zip_files:
        ...
        if answer == 'yes':
            source_folder = 'pocket color games'
        ...
        if answer == 'yes':
            ...
            if txt_files:
                print("Here are the text files in the 'pocket color plain text names' folder:")
                for file in txt_files:
                    print(file)
                
                print("\n\n\n")
                answer = input("Would you like to match the names above to your Pocket Color games and then rename them? (yes/no): ").strip().lower()
                ...
                if answer == 'yes':
                    ...
                    print("\n\n\nYour Pocket Color games have been renamed!\n\n\n")
    ...
    if answer == 'yes':
        gameboy_games_folder = 'pocket color games'
...
d8b   db d88888b  .d88b.          d888b  d88888b  .d88b.                                         
888o  88 88'     .8P  Y8.        88' Y8b 88'     .8P  Y8.                                        
88V8o 88 88ooooo 88    88        88      88ooooo 88    88                                        
88 V8o88 88~~~~~ 88    88 C8888D 88  ooo 88~~~~~ 88    88                                        
88  V888 88.     `8b  d8'        88. ~8~ 88.     `8b  d8'                                        
VP   V8P Y88888P  `Y88P'          Y888P  Y88888P  `Y88P'                                         
                                                                                                 
                                                                                                 
d8888b.  .d88b.   .o88b. db   dD d88888b d888888b       .o88b.  .d88b.  db       .d88b.  d8888b. 
88  `8D .8P  Y8. d8P  Y8 88 ,8P' 88'     `~~88~~'      d8P  Y8 .8P  Y8. 88      .8P  Y8. 88  `8D 
88oodD' 88    88 8P      88,8P   88ooooo    88         8P      88    88 88      88    88 88oobY' 
88~~~   88    88 8b      88`8b   88~~~~~    88         8b      88    88 88      88    88 88`8b   
88      `8b  d8' Y8b  d8 88 `88. 88.        88         Y8b  d8 `8b  d8' 88booo. `8b  d8' 88 `88. 
88       `Y88P'   `Y88P' YP   YD Y88888P    YP          `Y88P'  `Y88P'  Y88888P  `Y88P'  88   YD 
